    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow">
                <div class="card-body">
                    <div class="fs-4 fw-bold text-center">{{ isset($project) ? __('Update Project') : __('Add Project')}}</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{ isset($project) ? route('backend.projects.update', $project->id) : route('backend.projects.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content text-align-center mt-2">
                            ...
                            <div>
                                <a href="{{ route('backend.projects.index') }}" class="btn btn-danger ms-2">{{ __('Back') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
