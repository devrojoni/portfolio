...
<script src="{{ asset('assets/backend/vendor/nouislider/distribute/nouislider.min.js') }}"></script>
...
<script src="{{ asset('assets/backend/vendor/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js') }}">
</script>
