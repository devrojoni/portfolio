<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="../../index.html">
        <img class="navbar-brand-dark" src="{{ asset('assets/backend/assets/img/brand/light.svg') }}" alt="Volt logo" />
        ...
        <div
            ...
            <div class="d-flex align-items-center">
                <div class="avatar-lg me-4">
                    <img src="{{ asset('assets/backend/assets/img/team/profile-picture-3.jpg') }}"
            ...
            <li class="nav-item">
                <a href="{{ route('backend.dashboard') }}" class="nav-link d-flex align-items-center">
                    <span class="sidebar-icon">
                        <img src="{{ asset(setting('logo')) }}" height="20" width="20"
                            alt="Volt Logo">
                    </span>
            ...
            <li class="nav-item">
                <span class="nav-link  collapsed  d-flex justify-content-between align-items-center"
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">{{ __('Project') }}</span>
                    </span>
